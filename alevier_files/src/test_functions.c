...
void			test_ft_strstr_basic(void *ptr) {
	...
	SET_EXPLANATION("your strstr does not work with basic input 1");
...
void			test_ft_strstr_basic2(void *ptr) {
	typeof(strstr)	*ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input 2");
...
void			test_ft_strstr_basic3(void *ptr) {
	typeof(strstr)	*ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input 3");
...
void			test_ft_strstr_basic4(void *ptr) {
	typeof(strstr)	*ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input 4");
...
void			test_ft_strstr_basic5(void *ptr) {
	typeof(strstr)	*ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input 5");
